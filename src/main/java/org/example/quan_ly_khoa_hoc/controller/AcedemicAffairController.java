    ...
    public class AcedemicAffairController extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
            ...
            switch (action) {
                ...
                case "listTable":
                    ...
                    try {
                        req.getRequestDispatcher("/views/acedemic-affairs/home/table-list-class.jsp")
                                .forward(req, resp);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
        ...
        private void showClassDetail(HttpServletRequest req, HttpServletResponse resp) {
            ...
            req.setAttribute("allStudents", studentService.findStudentNotEnrolment(classId));
            try {
    ...
    // Load dropdown
        ...
        private void loadEditForm(HttpServletRequest req, HttpServletResponse resp) {
            ...
            req.setAttribute("teacherList", staffService.findAllTeachers());
            try {
                // trả về form HTML (chỉ form, không render toàn trang)
                req.getRequestDispatcher("/views/acedemic-affairs/home/form-edit-class.jsp")
                        .forward(req, resp);
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        private void handleAddClass(HttpServletRequest req, HttpServletResponse resp) throws IOException {
            boolean success = addClass(req);
            String msg = success ? "add_success" : "error";
            resp.sendRedirect(req.getContextPath() + "/acedemic-affairs?msg=" + msg);
        }


        private void handleUpdateClass(HttpServletRequest req, HttpServletResponse resp) throws IOException {
            boolean success = updateClass(req);
        ...
        private void handleDeleteClass(HttpServletRequest req, HttpServletResponse resp) throws IOException {
            int classId = Integer.parseInt(req.getParameter("id"));
            boolean success = classService.deleteById(classId);
            String msg = success ? "delete_success" : "error";
            resp.sendRedirect(req.getContextPath() + "/acedemic-affairs?msg=" + msg);
        }
    }
