                ...
                <form id="lessonForm" action="/admin/lessons?action=add" method="post" class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        <div class="col-md-8 mb-3">
                            <label for="lessonName" class="form-label d-flex align-items-center"><i class="bi bi-asterisk text-danger" style="font-size: 10px"></i>Tên Bài học</label>
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="sortOrder" class="form-label d-flex align-items-center"><i class="bi bi-asterisk text-danger" style="font-size: 10px"></i>Thứ tự</label>
                    ...
                    <div class="mb-3">
                        <label for="contentType" class="form-label d-flex align-items-center"><i class="bi bi-asterisk text-danger" style="font-size: 10px"></i>Loại nội dung</label>
