                ...
                <div class="card border-0 shadow">
                    <div class="card-body p-4 p-md-5">
                        <div class="text-center mb-5">
                            ...
                            <h3 class="mt-3">Hồ Sơ Giáo vụ</h3>
                            <p class="text-muted">
                        ...
                        <div class="mb-5">
                            ...
                            <dl class="row g-3">
                                ...
                                <dd class="col-sm-8">${teacher.getFullName()}</dd>

                                <dt class="col-sm-4 fw-bold">Chức vụ</dt>
                                <dd class="col-sm-8">${teacher.getPosition()}</dd>
                                <!-- Email -->
                                <dt class="col-sm-4 fw-bold">Email:</dt>
                                <dd class="col-sm-8">${teacher.getEmail()}</dd>

                                <!-- Số điện thoại -->
                                <dt class="col-sm-4 fw-bold">Số điện thoại:</dt>
                                <dd class="col-sm-8">${teacher.getPhone()}</dd>
                                ...
                                <dd class="col-sm-8">${teacher.getAddress()}</dd>
                            </dl>
                        </div>

                        <!-- Action Button -->
                        <div class="d-flex justify-content-center">
                            <a href="acedemic-affairs?action=update-profile">
                                <button class="btn btn-lg btn-outline-primary shadow-sm me-2">
                                    <i class="bi bi-pencil-square me-2"></i>Chỉnh sửa hồ sơ
                                </button>
                            </a>
                            <a href="acedemic-affairs?action=change-password">
